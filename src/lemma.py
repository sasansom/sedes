...
OVERRIDES = (
    ...
    ("τυδεΐδαο", "τυδεΐδης"),
    ("τυδείδη", "τυδεΐδης"),
    ("τυδείδῃ", "τυδεΐδης"),
    ("τυδείδην", "τυδεΐδης"),
    ("τυδέϊ", "τυδεύς"),
    ("πυρκαϊὴ", "πυρκαϊά"),
    ("πυρκαϊῇ", "πυρκαϊά"),
    ("πυρκαϊήν", "πυρκαϊά"),
    ...
    ("αἰγεΐδην", "αἰγεΐδης"),
    ("ἀλκεΐδαο", "ἀλκείδης"),
    ("ἀλκεΐδην", "ἀλκείδης"),
    ("ἀλλήλῃς", "ἀλλήλων"),
    ("κατενήνοθεν", "κατενήνοθεν"),
    ("κατέδυσε", "καταδύω"),
    ("καθεζόμενοι", "καθέζομαι"),
    ("κατεσσεύεσθε", "κατασεύομαι"),
    ("κατεναντίη", "κατεναντίος"),
    ("κατεναντία", "κατεναντίος"),
    ("κατερρίγησεν", "καταρριγέω"),
    ("κατημάλδυνε", "καταμαλδύνω"),
    ("κάταντες", "κατάντης"),
