...
expectancy.all.csv: $(WORKS_CSV)
	src/expectancy $^ > "$@"
expectancy.hellenistic+archaic.csv: corpus/iliad.csv corpus/odyssey.csv corpus/theogony.csv corpus/worksanddays.csv corpus/shield.csv corpus/argonautica.csv corpus/theocritus.csv corpus/aratus.csv
	src/expectancy $^ > "$@"
